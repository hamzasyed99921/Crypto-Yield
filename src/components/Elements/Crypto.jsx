        ...
        <div className="container">
          ...
          <div className="crypto_table mt-5">
            <div className="row d-flex align-items-center ">
                ...
                <div className="col-md-2 col-12">  <img src="assets/images/Graph.png" alt="" /></div>
                <div className="col-md-1 col-12"><button className="btn">Trade</button></div>
            </div>
            <hr />
            <div className="row d-flex align-items-center ">
                ...
                <div className="col-md-2 col-12">  <img src="assets/images/Graph2.png" alt="" /></div>
                <div className="col-md-1 col-12"><button className="btn">Trade</button></div>
            </div>
            <hr />
            <div className="row d-flex align-items-center ">
